...
Senior Software Engineer 💪 | Lifelong Learner 📚 | On a mission to be the best engineer I can be
...
- Prioritize shipping and iterating over perfection
- Focus on impact and technical excellence
- Stay hands-on with implementation

## My Journey 🌱
Not everyone takes a straight path to tech. My background taught me resilience, perspective, and the value of second chances. Those experiences shaped who I am today - someone who doesn't quit, appreciates every opportunity to grow, and believes in the power of transformation through learning and hard work.

## Beyond the Code 🌍
When I'm not writing code:
- 🏋️ Lifting heavy things (and putting them back down)
- 👨‍🍳 Experimenting with cuisines from around the world
- 🎓 Coaching and mentoring when time allows
- 📚 Always learning something new - challenges welcome

## Values ⚡
Lifelong learner. Problem solver. Zero tolerance for unnecessary BS.

---

*Always building, always learning, always lifting.*